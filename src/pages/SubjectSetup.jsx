...
const MANUAL = [
  {
    title: '전담 과목 설정',
    items: [
      '전담 수업에 사용할 과목을 추가합니다 (예: 영어, 과학, 체육, 통합).',
      '주당 시수: 해당 과목을 일주일에 몇 시간 가르치는지 설정합니다 (학년별 별도).',
      '담당 학년을 선택해 해당 학년에만 과목이 배정되도록 합니다.',
      '주요 과목 체크: 1명의 전담 교사에게 주요 과목 1개만 배정되도록 제한할 수 있습니다 (전담 배정 자동 알고리즘 옵션).',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      '"이 안 적용" 버튼을 누른 안만 실제로 사용됩니다 (다른 탭은 비교용).',
    ...
    <div className="p-4 md:p-10 bg-gray-50 min-h-full">
      <div className="flex items-start justify-between mb-6 max-w-[720px]">
        <div>
          ...
          <p className="text-[12px] text-gray-400 mt-1 break-keep">② 전담 수업에 쓸 과목을 학년별로 등록하세요. 과목명·주당 시수·주요/일반 구분을 입력합니다. (변경 사항은 자동 저장)</p>
        </div>
