...
story.append(Paragraph("문서 버전: 2026-05", caption_style))
...
story.append(Paragraph("수동 수정", h2_style))
story.append(bullet([
    "셀 클릭 → 모달에서 교사·과목·특별실을 직접 수정.",
    "미배정(빨간 셀)을 클릭해 수동으로 채울 수 있습니다.",
    "수동 편집은 즉시 학급별·특별실 시간표에 반영됩니다.",
]))

story.append(Paragraph("엑셀 내보내기", h2_style))
story.append(bullet([
    "교사별 엑셀: 교사 단위 시간표.",
    "학급별 엑셀: 학급 단위 시간표.",
]))
