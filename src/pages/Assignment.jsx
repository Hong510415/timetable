...
export default function Assignment() {
  ...
  return (
    <div className="p-4 md:p-10 bg-gray-50 min-h-full">
      ...
      <p className="max-w-[720px] text-[12px] text-gray-400 -mt-3 mb-5 break-keep">③ 어떤 교사가 어떤 과목·학년·반을 맡을지 정하세요. "자동 배정 실행" 후 표에서 직접 수정할 수 있고, "시간표에 적용"을 눌러야 시간표 생성에 반영됩니다.</p>
